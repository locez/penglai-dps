...
// 特效武器
export const 特效_武器_普通: EquipmentIds = [35775, 34760];
export const 特效_武器_英雄: EquipmentIds = [37252];
// 特效腰坠
export const 特效_腰椎_普通: EquipmentIds = [38791];
export const 特效_腰椎_英雄: EquipmentIds = [39855];
// 切糕套装
export const 切糕套装_普通: EquipmentIds = [
  96367, 96391, 96385, 96379, 96373, 96397,
];
export const 切糕套装_英雄: EquipmentIds = [
  98481, 98505, 98499, 98493, 98487, 98511,
];
// 大CW特效Ids
...
// 2件套会心 4件套 饮羽10%
export const 套装_两件套双会: EquipmentIds = [96189, 96219, 96249, 96159];
// 2件套 饮羽10% 4件套会心
